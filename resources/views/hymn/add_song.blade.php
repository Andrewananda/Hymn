...
@section('content')
    <div class="box box-primary">
        ...
        <form enctype="multipart/form-data" method="post" action="{{ route('hymn.create') }}">
            @csrf
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="number" name="number" class="form-control" id="number" placeholder="Add hymn number">
                        </div>
                    </div>
                </div>
